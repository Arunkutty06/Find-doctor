...
$sql=mysqli_query($conn,"SELECT password FROM doctor_login where password='$oldpassword'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
$userid=$_SESSION['uid'];
$ret=mysqli_query($conn,"update doctor_login set password='$newpassword' where id='$userid'");
