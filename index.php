...
<head>
  ...
  <link rel="icon" type="image/icon" href="login/favicon.ico">
...
<!--Header Upper-->
<section class="header-uper" id="your-element-selector">
      <div class="container clearfix">
        <h1 class="title"><span>FIN</span>D<span>OCTOR</span></h1>
            <div class="right-side">
                  <ul class="contact-info">
                        <li class="item">
                              ...
                              <strong class="text-shine" style="padding-bottom: 35px;">Email</strong>
                              <br>
                              <a href="#">
                        ...
                        <li class="item">
                              ...
                              <strong class="text-shine" style="padding-bottom: 35px;">Call Now</strong>
                              <br>
      ...
      <div class="container">
           ...
           <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                        <a href="login\Login.php">Doctor Login</a>
                  </li>
                        <!-- <li class="dropdown">
...
<div class="hero-slider">
    <!-- Slider Item -->
    <div class="slider-item slide1" style="background-image:url(images/slider/42-15423258_HomePage_Main_alt.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Slide Content Start -->
            ...
            <div class="col-md-12">
                <div class="cta-block">
                    ...
                    <div class="working-time item">
                        ...
                        <h2>GET YOUR APPOINTMENT SOON!</h2>
                        <!-- <ul class="w-hours">
		...
		<div class="row">
			<div class="col-sm-12 col-xs-12">
				<div class="image-content">
					<div class="section-title text-center" class="text-shine">
						<h3 style="padding-bottom: 150px;">Best Features
						</h3>
						<p class="text-shine" style="padding-bottom: 450px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam magni in at debitis <br>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="item">
								...
								<h6 class="text-shine" style="padding-right: 475px; bottom: 40px;">Orthopedics</h6>
								<p style="top:35px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil ducimus veniam illo quibusdam pariatur ex sunt, est aspernatur 
						...
						<div class="col-sm-6">
							<div class="item">
								...
								<h6 class="text-shine" style="padding-right: 475px; bottom: 40px;">Diaginostic</h6>
								<p style="top:35px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil ducimus veniam illo quibusdam pariatur ex sunt, est aspernatur
								at debitis eius vitae vel nostrum dolorem labore autem corrupti odit mollitia?</p>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="images/resource/3.png" alt="" style="padding-top: 50px">
										</a>
									</figure>
								</div>
								<h6 class="text-shine" style="padding-right: 500px; padding-top: 130px;">Psycology</h6>
								<p style="top:93px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil ducimus veniam illo quibusdam pariatur ex sunt, est aspernatur
								at debitis eius vitae vel nostrum dolorem labore autem corrupti odit mollitia?</p>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="item">
								<div class="icon-box">
									<figure>
										<a href="#">
											<img src="images/resource/4.png" alt="" style="padding-top: 50px">
										</a>
									</figure>
								</div>
								<h6 class="text-shine" style="padding-right: 400px; padding-top: 130px;">General Treatment</h6>
								<p style="top:90px;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil ducimus veniam illo quibusdam pariatur ex sunt, est aspernatur
								at debitis eius vitae vel nostrum dolorem labore autem corrupti odit mollitia?</p>
							</div>
						</div>
					</div>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="col-md-6">
                                <div class="contents">
                                    <div class="section-title">
                                        <h3 class="text-shine">dormitory</h3>
                                    </div>
                                    <div>
                        ...
                        <div class="service-box tab-pane fade in" id="orthopedic">
                            ...
                            <div class="col-md-6">
                                <div class="contents">
                                    <div class="section-title">
                                        <h3 class="text-shine">orthopedic</h3>
                                    </div>
                                    <div class="text">
                        ...
                        <div class="service-box tab-pane fade in" id="sonogram">
                            ...
                            <div class="col-md-6">
                                <div class="contents">
                                    <div class="section-title">
                                        <h3 class="text-shine">sonogram</h3>
                                    </div>
                                    <div class="text">
                                        <p>The implant fixture is first placed, so that it ilikely to osseointegrate, then a dental prosthetic is added.
                                            then a dental prosthetic is added.then a dental pros- thetic is added.</p>
                        ...
                        <div class="service-box tab-pane fade in" id="diagnostic">
                            ...
                            <div class="col-md-6">
                                <div class="contents">
                                    <div class="section-title">
                                        <h3 class="text-shine">diagnostic</h3>
                                    </div>
                                    <div class="text">
                                        <p>The implant fixture is first placed, so that it ilikely to osseointegrate, then a dental prosthetic is added.
                                            then a dental prosthetic is added.then a dental pros- thetic is added.</p>
...
<section class="service-section bg-gray section">
    <div class="container">
        <div class="section-title text-center">
            <h3>Provided
                <span class="text-shine" style="font-size: 45px; left: 740px; bottom: -60px;">Services</span>
            </h3>
...
<section class="team-section section">
    <div class="container">
        <div class="section-title text-center">
            <h3>Our Expert
                <span class="text-shine" style="font-size: 45px; left: 750px; bottom: -70px;">Doctors</span>
            </h3>
...
<section class="appoinment-section section">
    ...
    <div class="section-title">
        ...
        <h3 style="padding-bottom: 700px; padding-right: 500px;">FAQ</h3>
    </div>
    </div>
...
<div class="accordion-holder">
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
        ...
        <div class="panel panel-default">
            ...
            <div id="" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="about-widget">
            <div class="footer-logo">
              <figure>
                <h1 class="black-lives-matter" style="font-size: 40px;">FinDoctor</h1>
              </figure>
            </div>
